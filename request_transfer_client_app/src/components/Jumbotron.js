                ...
                return (
                    <div className="container" style={divStyle} onMouseOver={this.handleMouseOver.bind(this)}
                        ...
                        <div className="jumbotron" style={jStyle}>
                            ...
                            <div><h3 ><strong>URL :</strong> <a style={{color:'black'}}>http://localhost:8080/request</a></h3></div>

                            <div><h3 ><strong>Header Parameter : </strong><br/>
                                appId:<div >{this.props.appId}</div>
                            </h3></div>
                            <div><strong><h3 >
                                Post Request Body
                                    :</h3>
                                <code style={{color:'black'}}>{JSON.stringify(JSON.parse(this.props.request), null, 6)}</code></strong>
                            </div>
