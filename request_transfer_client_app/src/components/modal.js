...
export class Modal extends Component {
    ...
    renderBtnWithConfirm() {
        if (this.state.saveClicked) {
            return <button style={{background: 'transparent'}} type="button" data-dismiss="modal"
                           onClick={this.handleOk.bind(this)} className="btn btn-default">Ok</button>;
        }
        return <button style={{background: 'transparent'}} type="button" onClick={this.handleSave.bind(this)}
                       className="btn btn-default">{this.props.submitButton}</button>;
    }
    ...
    render() {
        return (
            <div className="modal fade" id={this.props.modalId} tabindex="-1" role="dialog"
                 aria-labelledby="myModalLabel" ref={this.props.ref}>
                    ...
                    <div className="modal-content" style={{backgroundColor: 'white'}}>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-default" data-dismiss="modal"
                                    style={{background: 'transparent'}}>Close
                            </button>
