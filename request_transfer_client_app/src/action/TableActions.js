...
export function updateStoreForModal(keyValue, listOperations, operationValues, customNames, modalData) {
    dispatcher.dispatch(
        {
            type: "MODAL_UPDATE",
            keyValue,
